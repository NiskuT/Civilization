...
{
    /*client::TextureDisplayer texture1("../resources/img/map/ressource-antic.png");
    BOOST_CHECK(texture1.getSize() == 0);

    client::TextureDisplayer texture2("../resources/img/map/ressource-stone.png");
    BOOST_CHECK(texture2.getSize() == 0);*/
}

BOOST_AUTO_TEST_CASE( addSpriteGetSize )
{
    /*client::TextureDisplayer texture1("../resources/img/map/ressource-stone.png");
